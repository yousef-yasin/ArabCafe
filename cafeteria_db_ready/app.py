...
def protect_admin_pages_globally():
    """
    Extra safety layer: even if a new admin route is added later and
    @admin_required is forgotten, it will still require login.
    The admin login page itself stays public.
    """
    admin_root = f'/{ADMIN_SECRET_PATH}'
